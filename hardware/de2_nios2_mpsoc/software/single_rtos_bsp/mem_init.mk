...
# Memory: shared_onchip
MEM_1 := nios2_mpsoc_shared_onchip
$(MEM_1)_NAME := shared_onchip
...
$(MEM_1)_START := 0x00102000
$(MEM_1)_END := 0x00103fff
$(MEM_1)_HIERARCHICAL_PATH := shared_onchip
$(MEM_1)_WIDTH := 32
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0

.PHONY: shared_onchip
shared_onchip: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
