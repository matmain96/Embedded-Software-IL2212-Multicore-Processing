...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../de2_nios2_mpsoc.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios2_mpsoc.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios2_mpsoc
SOPC_NAME := nios2_mpsoc
...
# The SOPC System ID 
# setting SOPC_SYSID is 538186246
SOPC_SYSID_FLAG += --id=538186246
ELF_PATCH_FLAG  += --id 538186246

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x1051c8
SOPC_SYSID_FLAG += --sidp=0x1051c8
ELF_PATCH_FLAG  += --sidp 0x1051c8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1423040903
SOPC_SYSID_FLAG += --timestamp=1423040903
ELF_PATCH_FLAG  += --timestamp 1423040903
